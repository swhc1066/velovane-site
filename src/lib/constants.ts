...
export const APP_GALLERY_ITEMS = [
  ...
  },
  {
    ...
    image: "/mockups/week-detail.png",
    alt: "VeloVane week detail with best ride window",
  },
  {
    stamp: "03 · HOUR DETAIL",
    label: "Zoom in",
    text: "Every hour. Every detail.",
    image: "/mockups/hour-detail.png",
    alt: "VeloVane hour detail with weather metrics",
  },
  {
    stamp: "04 · PREFERENCES",
    label: "Tuned to you",
    text: "Your thresholds. We learn the rest.",
    image: "/mockups/preferences.png",
    alt: "VeloVane preferences thresholds temperature range",
  },
] as const;
